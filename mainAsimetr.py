...
drowGraph(inputValueDeepPointSubT1M, "Deep Point1 - T1")
drowGraph(inputValueDeepPointSubT2M, "Deep Point1 - T2")
drowGraph(inputValueOutsidePointSubAxillaryM, "Outside Point1 - Axillary")
drowGraph(inputValueOutsidePointSubT1M, "Outside Point1 - T1")
drowGraph(inputValueOutsidePointSubT2M, "Outside Point1 - T2")
